  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Oda Zilizokamilika</span>
          <h3 className="text-2xl font-black text-emerald-600 mt-2">{stats.completedOrders}</h3>
        </div>
      </div>
